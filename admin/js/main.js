...
$(document).ready(function(){
	...
	$(document).on('click', '.edit_dj', function(event) {
		...
		ajx("dj_data",data).done(function(dj) {
			...
			var iframe = '<iframe class="pw-modal-window ui-dialog-content ui-widget-content" frameborder="0" src="/agency/processwire/page/edit/?id='+id+'&amp;fields=gallery&amp;modal=1" id="pw-modal-window-1" style="height: 100%;width: 100%;" id="frame_edit"></iframe>'
  ...
  beforeSend: function() {
  	console.log("Función="+parent);
		...
		success: function respuesta(datos_ans) {
			...
			// var iframe = '<iframe class="pw-modal-window ui-dialog-content ui-widget-content" frameborder="0" src="/agency/processwire/page/edit/?id='+temp_id+'&amp;fields=gallery&amp;modal=1" id="pw-modal-window-1" style="height: 100%;width: 100%;" id="frame_edit"></iframe>'
			// if (editing == "null") {$("#frame_edit_cont").html(iframe);}
		},
